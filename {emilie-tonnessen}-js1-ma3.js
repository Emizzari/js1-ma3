...
//  QUESTION 2
/*  Refer: lesson 2 / 4
    - Make a call to the URL below, pass the JSON it returns to a function and inside 
      that function loop through the results and log each game's name.
...
//  QUESTION 5
/*  Refer: lesson 4
    - Write code that removes the button, and only the button, from its parent 
